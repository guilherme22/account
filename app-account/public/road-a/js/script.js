...
appData.start = function(){
    ...
    appData.ajaxGet(urlService+"road-a/linhas.json", function(data){
    ...
    appData.ajaxGet(urlService+"road-a/pizzaesquerda.json", function(data){
        var pieData = [
                {
                    value: data.Dia,
                    color:"#F38630"
    ...
    appData.ajaxGet(urlService+"road-a/pizzadireita.json", function(data){
        var pieData2 = [
                {
                    value: data.Dia,
                    color:"#E65B5B"
    ...
    appData.ajaxGet(urlService+"road-a/barraum.json", function(data){
    ...
    appData.ajaxGet(urlService+"road-a/barradois.json", function(data){
    ...
    appData.ajaxGet(urlService+"road-a/barratres.json", function(data){
...
appData.startMapPage = function(){
    appData.ajaxGet(urlService+"road-a/grid.json", function(sucesso){
        TableData = sucesso;
